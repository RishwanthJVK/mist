...
A high-fidelity, web-based replication of the Montreal Imaging Stress Task (MIST) designed for functional imaging and behavioral research. This application induces moderate psychosocial stress through adaptive mental arithmetic and social evaluative threat.

## Tech Stack
* **Frontend:** React + Vite for sub-second UI reactivity.
* **Backend/Database:** Supabase (Auth, PostgreSQL, Realtime) for granular trial logging and session control.
...
* [cite_start]**is_correct**: Binary accuracy or Timeout flag[cite: 80, 81, 95].
* **current_limit_ms**: The adaptive time window active during the trial[cite: 65, 88].
* [cite_start]**condition_type**: Rest, Control, or Experimental[cite: 62].
...
Gemini said
Markdown
# MIST-Explorer: Montreal Imaging Stress Task Implementation
